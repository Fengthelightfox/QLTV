...
create table Thong_tin_nguoi_muon (
...
-- Bổ sung dữ liệu cho bảng SACH sử dụng GETDATE() trong SQL Server
...
-- Bổ sung dữ liệu cho bảng Thong_tin_nguoi_muon
INSERT INTO Thong_tin_nguoi_muon (Ma_doc_gia, Ten_tai_khoan, Mat_khau, Ho_ten, So_dien_thoai, Phuong_Xa, Quan_huyen, Tinh)
VALUES
...
ALTER TABLE Sach
ALTER COLUMN Ma_sach VARCHAR(255) NOT NULL;
ALter table Thong_tin_nguoi_muon
Alter column Ma_doc_gia varchar(255) not null;
